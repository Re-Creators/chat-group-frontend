<template>
    <div v-if="user">
       ...
       <div class="w-full md:w-3/5 mx-auto relative">
            ...
            <div class="w-full rounded-lg md:border border-gray-300 p-10 mt-5">
                <div class="w-full md:w-1/2 text-white">
                    <h1 class="text-lg font-semibold">Change Info</h1>
                    <p class="text-sm">Changes will be reflected to every services</p>
                    ...
                    <div class="mt-10 text-white">
                        <form @submit.prevent="submitForm">
                            <div class="text-sm mb-5">
                                ...
                                <input type="text" class="w-full p-3 bg-input rounded-lg" placeholder="Enter your name.."  v-model="name">
                            </div>
                            <div class="text-sm mb-5">
                                <p class="font-semibold">Bio</p>
                                <textarea class="resize-none bg-input w-full p-3 rounded-lg" cols="30" rows="5" placeholder="Enter your bio.." v-model="bio"></textarea>
                            </div>
                            <div class="text-sm mb-5">
                                <p class="font-semibold">Phone</p>
                                <input type="text" class="bg-input w-full p-3 rounded-lg" placeholder="Enter your phone.." v-model="phone">
                            </div>
                            <div class="text-sm mb-5">
                                <p class="font-semibold">Email</p>
                                <input type="email" class="bg-input w-full p-3 rounded-lg focus:border-0" v-model="email" readonly>
                            
                            </div>
                            <div class="text-sm mb-5" v-if="!useProvider">
                                <p class="font-semibold">Password</p>
                                <input type="password" class="bg-input w-full p-3 rounded-lg" placeholder="Enter your new password.." v-model="password">
                            </div>
                            <div class="text-sm mb-5">
